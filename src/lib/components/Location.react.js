 ...
 *
 * This is a modified version of the dash-core-components Location component. It allows multiple
 * intances to co-exist. In the dcc version the last instance is the only one to 
 * get history event notifications.
 */

export default class Location extends Component {
    constructor(props) {
        super(props);
        // console.log('Location.constructor(id=%s)', this.props.id)
        this.updateLocation = this.updateLocation.bind(this);
        this.onLocationChange = this.onLocationChange.bind(this);
    }

    /**
     * Called when location property changes
     */
    ...
    updateLocation(props) {
        ...
        // console.log('updateLocation id=%s, href=%s, pathname=%s', props.id, href, pathname)
    ...
    /**
     * Connected to windows event handler 
     */
    ...
    onLocationChange() {
        ...
        // console.log('onLocationChange id=%s', this.props.id)
